...
<Card className="max-w-sm">
  ...
  <p className="text-white/70 text-sm">
    Writing software by describing the intent and letting AI handle the syntax.
  </p>
</Card>
`.trim();
    ...
    <main className="min-h-screen flex flex-col items-center pt-24 pb-32 px-6">
      ...
      <section className="text-center max-w-3xl mb-24 space-y-6">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 text-sm text-white/80 mb-4">
          ...
          <span>Vibe UI v2.0 - Live Playground is now live</span>
        </div>
        ...
        <p className="text-lg text-white/60 max-w-xl mx-auto">
          Copy and paste beautifully designed, animated, and accessible React components. Now with an interactive Live Playground!
        </p>
      ...
      {/* Component Showcase (Now with LivePlayground) */}
      <section className="w-full max-w-6xl space-y-24">
        ...
        <div className="space-y-6">
          ...
          <LivePlayground usageCode={buttonUsage} componentCode={buttonCode} />
        </div>
        ...
        <div className="space-y-6">
          ...
          <LivePlayground usageCode={cardUsage} componentCode={cardCode} />
        </div>
        ...
        <div className="space-y-6">
          ...
          <LivePlayground usageCode={inputUsage} componentCode={inputCode} />
        </div>
